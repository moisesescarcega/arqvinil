...
export const colorDevices = [
    { name: "Negro mate", value: 0, color: '#080808', roughness: 0.7, metalness: 0.2 },
    { name: "Plateado satinado", value: 1, color: '#585858', roughness: 0.25, metalness: 0.2 },
    { name: "Blanco brillante", value: 2, color: '#eeeeee', roughness: 0.05, metalness: 0.2 },
    { name: "Azul intenso", value: 3, color: '#222288', roughness: 0.1, metalness: 0.6 },
